import { ChatInputCommandInteraction, SlashCommandBuilder, EmbedBuilder, GuildMember, PermissionFlagsBits, TextChannel } from 'discord.js';
...
export const banCommand = {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    try {
      ...
      await logInfraction(interaction.guild!.id, targetUser.id, interaction.user.id, 'ban', reason);
