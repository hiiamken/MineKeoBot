...
export const muteCommand = {
  ...
  async execute(message: Message, args: string[]) {
    ...
    if (
      ...
      return message.reply({
        content:
          "⚠ Bot không có quyền cấm nói người dùng! Hãy kiểm tra quyền của bot.",
      });
    }
    ...
    if (
      ...
      return message.reply({
        content:
          "⚠ Bot không thể mute người có quyền cao hơn hoặc ngang bằng nó!",
      });
    }
    ...
    if (message.member.roles.highest.position <= user.roles.highest.position) {
      return message.reply({
        content:
          "⚠ Bạn không thể mute người có quyền cao hơn hoặc ngang bằng bạn!",
      });
    }
  ...
  `
      ...
      return message.reply({
        content:
          "⚠ Đã xảy ra lỗi khi mute người dùng. Vui lòng kiểm tra lại quyền của bot!",
      });
    }
  },
};
