const { EmbedBuilder, ButtonStyle, ActionRowBuilder, ButtonBuilder, SlashCommandBuilder } = require('discord.js');
const math = require('mathjs');

module.exports = {
    data: new SlashCommandBuilder()
        .setName(`maytinh`)
        .setDescription(`Sử dụng máy tính`),
    async execute(interaction) {

        const idPrefix = 'maytinh';
        ...
        const row1 = new ActionRowBuilder()
            .addComponents(
                new ButtonBuilder()
                    ...
                    .setStyle(ButtonStyle.Secondary), // Thay đổi style thành Secondary
                new ButtonBuilder()
                    .setLabel("2")
        ...
        const row2 = new ActionRowBuilder()
            .addComponents(
                ...
                new ButtonBuilder()
                    .setLabel("x")
                    .setCustomId(idPrefix + "_*") // Đổi custom_id thành "_*" để biểu diễn phép nhân
                    .setStyle(ButtonStyle.Primary),
            );
        ...
        collector.on('collect', async i => {
            ...
            if (value === "=") {
                try {
                    ...
                    data = "";
                    extra = "Lỗi, bấm AC để restart";
                }
            } else if (value === "clear") {
                data = "";
                extra = "Kết quả hiển thị tại đây";
