...
exports.antiRaidRollbackCommand = void 0;
const discord_js_1 = require("discord.js");
const database_1 = require("../../database/database");
exports.antiRaidRollbackCommand = {
    ...
    async execute(interaction) {
        ...
        const logs = await db.all(`SELECT * FROM antiRaid_logs WHERE guild_id = ? AND action_status = 'pending' ORDER BY join_timestamp DESC LIMIT ?`, [guild.id, limit]);
