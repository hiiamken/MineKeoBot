...
exports.rerollGiveawayCommand = void 0;
const discord_js_1 = require("discord.js");
const giveaway_1 = require("../../../database/giveaway"); // ✅ Dùng `message_id`
const giveawayParticipants_1 = require("../../../database/giveawayParticipants");
exports.rerollGiveawayCommand = {
    ...
    async execute(interaction) {
        ...
        const giveaway = await (0, giveaway_1.getGiveawayByMessageId)(guildId, messageId);
        if (!giveaway) {
            return interaction.reply({
