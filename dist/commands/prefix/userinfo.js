...
exports.userinfoPrefixCommand = void 0;
...
exports.userinfoPrefixCommand = {
    ...
    async execute(message, args) {
        ...
        const economyAndMessagesData = await (0, userDatabase_1.getUserData)(message.guild.id, user.id);
        // Lấy thông tin level riêng
        const levelData = await (0, levelManager_1.getUserLevel)(message.guild.id, user.id);
